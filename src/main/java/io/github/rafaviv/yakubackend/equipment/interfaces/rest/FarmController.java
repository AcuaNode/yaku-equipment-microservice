...
public class FarmController {
    ...
    public ResponseEntity<FarmResource> createFarm(@RequestBody CreateFarmResource resource, org.springframework.security.core.Authentication authentication) {
        io.github.rafaviv.yakubackend.equipment.infrastructure.authorization.sfs.model.UserDetailsImpl userDetails = 
            (io.github.rafaviv.yakubackend.equipment.infrastructure.authorization.sfs.model.UserDetailsImpl) authentication.getPrincipal();
